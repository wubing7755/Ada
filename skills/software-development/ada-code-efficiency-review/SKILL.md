...
description: "Use when reviewing code for performance and efficiency — spot redundant work, N+1 queries, missed concurrency opportunities, hot-path bloat, TOCTOU races, memory leaks, excessive reads, and silent failures. Language-agnostic with actionable fix recommendations."
version: 1.0.0
author: Hermes Agent
license: MIT
